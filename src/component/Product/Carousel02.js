...
const Carousel01 = ({ Catgories, setCatgories }) => {
  ...
  const Arrau = [
    { image: "Japansec.jpg", Name: "Japonais" },
    { image: "Americanfood01.jpg", Name: "Américain", Note: 98 },
    ...
    { image: "Maxican02.jpg", Name: "Mexicain", Note: 60 },
    { image: "Pizaaital.jpg", Note: 60, Name: "Italien" },
  ];
  ...
  return (
    <div>
      <p
        className="text-2xl font-semibold leading-tight ml-14 absolute mt-2	"
        style={{ height: "" }}
      >
        Top Categories
      </p>
